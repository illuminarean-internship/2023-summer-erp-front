                                ...
                                <Grid item xs={8}>
                                    ...
                                    >
                                        <TextField
                                            ...
                                            type="number"
                                            fullWidth
                                            value={testDeviceInfo.repairPrice}
                                            onChange={handleChange}
                                            InputProps={{
                                                style: {
                                                    height: '50px',
                                ...
                                <Grid item xs={8}>
                                    ...
                                    >
                                        <TextField
                                            ...
                                            fullWidth
                                            value={testDeviceInfo.repairDetails}
                                            onChange={handleChange}
                                            inputProps={{
                                                style: {
                                                    height: '16px',
                                ...
                                <Grid item xs={8}>
                                    ...
                                    >
                                        <TextField
                                            ...
                                            fullWidth
                                            value={testDeviceInfo.resellPrice}
                                            onChange={handleChange}
                                            InputProps={{
                                                style: {
                                                    height: '50px',
                                ...
                                <Grid item xs={8}>
                                    ...
                                    >
                                        <TextField
                                            ...
                                            fullWidth
                                            value={testDeviceInfo.karrotPrice}
                                            onChange={handleChange}
                                            InputProps={{
                                                style: {
                                                    height: '50px',
